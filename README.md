...
<p align="center">
  <img alt="GitHub language count" src="https://img.shields.io/github/languages/count/jerp86/gostack-typeorm-relations?color=%2304D361">
...
<p align="center">
  ...
  <a href="#links-úteis">Links úteis</a> <br>
...
Para nos ajudar nesse desafio, a **[Rocketseat](https://rocketseat.com.br/)** criou um modelo que deve ser utilizado como um template do Github.
...
**Dica**: Caso você não saiba utilizar repositórios do Github como template, existe um guia em **[FAQ Desafios](https://github.com/Rocketseat/bootcamp-gostack-desafios/tree/master/faq-desafios).**

Agora navegue até a pasta criada e abra no Visual Studio Code, ou sua IDE de preferência, lembre-se de executar o comando `yarn` no seu terminal para instalar todas as dependências.

Caso prefira utilizar o NPM, exclua o arquivo *yarn.lock* e rode o `npm install`.

---

### Rotas da aplicação

Agora que o template está clonado e pronto para continuar, deve ser verificado os arquivos da pasta `src` e completar onde não possui código com o código para atingir os objetivos de cada rota.
...
Caso você tenha dúvidas quanto ao que são os testes, e como interpretá-los, dê uma olhada em **[FAQ Desafios Bootcamp](https://github.com/Rocketseat/bootcamp-gostack-desafios/tree/master/faq-desafios).**
